...
export default {
  ...
  data: () => {
    return {
      arr: [
        {name: 'Ivan', info: '已获得礼物5件', current: '291g', img: 'https://avatars3.githubusercontent.com/u/439365?v=3&s=40'},
        {name: 'Ivan', info: '已获得礼物4件', current: '191g', img: 'https://avatars3.githubusercontent.com/u/439365?v=3&s=40'},
        {name: 'Ivan', info: '已获得礼物3件', current: '91g', img: 'https://avatars3.githubusercontent.com/u/439365?v=3&s=40'},
        {name: 'Ivan', info: '已获得礼物2件', current: '29g', img: 'https://avatars3.githubusercontent.com/u/439365?v=3&s=40'},
