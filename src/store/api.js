...
export const stealWater = (context, options) => {
  ...
  return context.get(`/growUp/stealWater?srcUserPin=${
      options.srcUserPin || 'USER_1'
    }&stolenUserPin=${
      options.stolenUserPin || 'USER_2'
    }&waterId=${
      options.waterId || 2
    }`)
}
...
export const creditsConvertGoods = (context, options) => {
  ...
  return context.get(`/growUp/creditsConvertGoods?userPin=${
      options.userPin || 'USER_1'
    }&fruitId=${
      options.fruitId || 2
  }`)
}
...
export const watering = (context, options) => {
  ...
  return context.get(`/growUp/watering?userPin=${
      options.userPin || 'USER_1'
    }&waterId=${
      options.waterId || 2
  }`)
...
export const getStealWaterInfo = (context, options) => {
  ...
  return context.get(`/user/getStealWaterInfo?userPin=${
      options.userPin || 'USER_1'
  }`)
}
...
export const getFriendsInfo = (context, options) => {
  ...
  return context.get(`/user/getFriendsInfo?userPin=${
    options.userPin || 'USER_1'
  }`)
}
...
export const getAwardsByCredits = (context, options) => {
  ...
  return context.get(`/user/getAwardsByCredits?credit=${
    options.credit || 3
  }`)
}
...
export const getTreeGrowValue = (context, options) => {
  ...
  return context.get(`/user/getTreeGrowValue?userPin=${
    options.userPin || 'USER_1'
  }`)
}
...
export const getUnusedWater = (context, options) => {
  ...
  return context.get(`/user/getUnusedWater?userPin=${
    options.userPin || 'USER_1'
  }`)
}
...
export const getTree = (context, options) => {
  ...
  return context.get(`/user/getTree?userPin=${
    options.userPin || 'USER_1'
  }`)
}
